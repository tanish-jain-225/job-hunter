...
* **The Solution:** 
  * **Enable Zero-Quota Split Mode (Recommended):** Add a free `GROQ_API_KEY` to `.env`. Job Hunter will automatically route Stage 1 batch screening to Groq (`llama-3.1-8b-instant`) with 30 RPM and 14,400 Requests/Day capacity, completely bypassing Gemini rate limits!
