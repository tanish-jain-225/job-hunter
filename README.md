...
<p align="center">
  ...
  <a href="tests/"><img src="https://img.shields.io/badge/tests-419%20passed-success?style=for-the-badge&logo=pytest&logoColor=white" alt="Tests"></a>
...
├── tests/                    # 419 automated test cases with 90%+ line coverage
...
Run the full automated test suite locally (**419 unit & integration tests**):
...
| **5. Full Automated Test Suite**| `pytest -q` | **419 passed tests** with 100% success rate | Verified |
